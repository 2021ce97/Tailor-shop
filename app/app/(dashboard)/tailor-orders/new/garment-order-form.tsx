...
export function GarmentOrderForm({ locale, title, customers, garmentTypes }: { locale: "en" | "fa" | "ps"; title: string; customers: SearchableOption[]; garmentTypes: GarmentType[] }) {
