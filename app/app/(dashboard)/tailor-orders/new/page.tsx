import { db, customers, fabrics, garmentDesignCategories, garmentDesignOptions, garmentMeasurementFields, garmentTypes } from "@/lib/db";
...
export default async function NewTailorOrderPage() {
  ...
  const [customerRows, typeRows, fieldRows, categoryRows, optionRows, fabricRows] = await Promise.all([
